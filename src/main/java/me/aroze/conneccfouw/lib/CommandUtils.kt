package me.aroze.conneccfouw.lib

import me.aroze.conneccfouw.ConneccFouw.Companion.getInstance
import me.aroze.conneccfouw.lib.coloured
...
fun CommandSender.isRightless(permission: String, message: String = "lol u wish") : Boolean {
    if (this.hasPermission("conneccfouw.$permission")) return false
